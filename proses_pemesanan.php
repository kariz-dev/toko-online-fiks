<?php
    ...
    $query = mysqli_query($koneksi, "INSERT INTO pesanan (nama_penerima, user_id, nomor_telepon, kota_id, alamat, tanggal_pesanan, status)
                                                        VALUES ('$nama_penerima', '$user_id', '$nomor_telepon', '$kota', '$selamat', '$waktu_saat_ini', '0')");
